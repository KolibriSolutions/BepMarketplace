...
urlpatterns = [
    ...
    path('wizard/step2/<str:kind>/', views.wizard_step2_edit, name='presentationswizardstep2_edit'),
    # path('wizard/step2/edit/', views.wizard_step2_edit, name='presentationswizardstep2_edit'),
