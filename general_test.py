...
class ViewsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.p_all_this_dist=   [403, 200, 403, 200, 403, 200, 403, 200, 200, 403, 403, 403, 403, 200, 403, 403, 403, 200, 302]  # staff of this proposal, as distributed to r-s (not t-p!) and assessor. Also type6.
